...
window.DEMO = (function () {
  ...
  var isEmirleri = [
    ...
    { id: 'IE-2026-0003', lokasyonId: 'LOK-0103', projeId: 'PRJ-2026-001', tarih: '2026-06-18', saat: '08:30', bitis: '2026-06-18', taseronId: 'TSR-001', ekipId: ['PRS-008'],           cihazlar: ['CHZ-002','CHZ-008'], operasyonDurum: 'kontrol-tamamlandi', raporDurum: 'onaylandi',     musteriTarihOnayi: true,  hazirlikTamam: true,  raporId: 'RPR-2026-0003', not: 'Rapor teknik onaydan geçti, müşteri teslimi bekleniyor.' },
    ...
    { id: 'IE-2026-0008', lokasyonId: 'LOK-0202', projeId: 'PRJ-2026-002', tarih: '2026-06-09', saat: '09:00', bitis: '2026-06-09', taseronId: 'TSR-004', ekipId: ['PRS-007'],           cihazlar: ['CHZ-001','CHZ-007'], operasyonDurum: 'kontrol-tamamlandi', raporDurum: 'imzalandi',     musteriTarihOnayi: true,  hazirlikTamam: true,  raporId: 'RPR-2026-0008', not: 'Rapor imzalandı; müşteri teslim planı hazırlanıyor.' },
    ...
    { id: 'IE-2026-0010', lokasyonId: 'LOK-0304', projeId: 'PRJ-2026-003', tarih: '2026-07-07', saat: '09:00', bitis: '2026-07-07', taseronId: 'TSR-001', ekipId: ['PRS-008'],           cihazlar: ['CHZ-002','CHZ-008'], operasyonDurum: 'kontrol-tamamlandi', raporDurum: 'onaylandi',     musteriTarihOnayi: true,  hazirlikTamam: true,  raporId: 'RPR-2026-0010', not: 'Mamul deposu kontrolü sorunsuz tamamlandı.' },
  ...
  var raporlar = [
    ...
    { id: 'RPR-2026-0003', no: 'GVT-2026-0003', isEmriId: 'IE-2026-0003', lokasyonId: 'LOK-0103', projeId: 'PRJ-2026-001', sablonId: 'SBL-ELK-01', kategoriId: 'KAT-04', kontrolTarihi: '2026-06-18', raporTarihi: '2026-06-22', teslimTarihi: null,        kontrolPersoneliId: 'PRS-008', onaylayanId: 'PRS-004', durum: 'onaylandi',    versiyon: 1, slaGun: 7, sonuc: 'uygun',        uygunsuzlukSayisi: 1, ekipmanSayisi: 38, revizyonKaynagi: null },
  ...
  var hakedisler = [
    ...
    { id: 'HKD-2026-003', no: 'HKD-2026-003', projeId: 'PRJ-2026-001', musteriId: 'MST-001', donem: '2026-06', lokasyonSayisi: 1, hazirlayanId: 'PRS-012', onaylayanId: null,      tarih: '2026-06-25', durum: 'onay-bekliyor', faturaId: null, not: 'Bornova şubesi; rapor onaylandı, mutabakat tamam.' },
    { id: 'HKD-2026-004', no: 'HKD-2026-004', projeId: 'PRJ-2026-003', musteriId: 'MST-003', donem: '2026-07', lokasyonSayisi: 1, hazirlayanId: 'PRS-012', onaylayanId: null,      tarih: '2026-07-14', durum: 'hazirlaniyor',  faturaId: null, not: 'Manisa mamul deposu; fatura grubu hedefi bekleniyor.' }
  ];
  ...
  var taseronHakedisleri = [
    ...
    { id: 'TH-2026-003', no: 'TH-2026-003', taseronId: 'TSR-001', projeId: 'PRJ-2026-001', donem: '2026-06', lokasyonlar: ['LOK-0103'],            isEmirleri: ['IE-2026-0003'],                tutar: 22940,  tarih: '2026-06-26', durum: 'musteri-tahsilati-bekleniyor', odemeTarihi: null,        musteriFaturaId: null,            not: 'Rapor onaylandı, müşteri faturası henüz kesilmedi.' },
    { id: 'TH-2026-004', no: 'TH-2026-004', taseronId: 'TSR-004', projeId: 'PRJ-2026-002', donem: '2026-06', lokasyonlar: ['LOK-0202'],            isEmirleri: ['IE-2026-0008'],                tutar: 243582, tarih: '2026-06-20', durum: 'taseron-faturasi-bekleniyor', odemeTarihi: null,        musteriFaturaId: null,            not: 'Hakediş onaylandı; taşeron faturası bekleniyor.' },
    ...
    { id: 'TH-2026-007', no: 'TH-2026-007', taseronId: 'TSR-001', projeId: 'PRJ-2026-003', donem: '2026-07', lokasyonlar: ['LOK-0304'],            isEmirleri: ['IE-2026-0010'],                tutar: 162274, tarih: '2026-07-16', durum: 'odemeye-uygun',               odemeTarihi: null,        musteriFaturaId: null,            not: 'Rapor onaylandı ve taşeron faturası alındı; ödeme onayı bekleniyor.' }
  ];
